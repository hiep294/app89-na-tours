      ...
      <footer className="footer">
         <div className="footer__logo-box">
            <picture className="footer__logo">
               <source srcSet="/static/img/logo-green-small-1x.png 1x, img/logo-green-small-2x.png 2x" media="(max-width: 37.5em)" />
               <img srcSet="/static/img/logo-green-1x.png 1x, img/logo-green-2x.png 2x" alt="Full logo" src="/static/img/logo-green-2x.png" />
            </picture>
         </div>
         <div className="row">
